...
|     elastic      | adjective |      灵活有弹性的      |    AWS Elastic Compute Cloud (EC2) 有「弹性、伸缩性」的特点  |     [Google 🔈](https://www.google.com/search?q=how+to+pronounce+elastic)      |
...
|     polyfill     |   noun    |         填充物         |   常指代 JavaScript 的特性，[MDN 说明](https://developer.mozilla.org/zh-CN/docs/Glossary/Polyfill)   |     [Google 🔈](https://www.google.com/search?q=how+to+pronounce+polyfill)     |
...
|    workaround    |   noun    | 解决方案 |   特指方案具有迂回性质   |    [Google 🔈](https://www.google.com/search?q=how+to+pronounce+workaround)    |
